...
class IPAdapter(nn.Module):
    ...
    def get_image_embeds(self, clip_embed, clip_embed_zeroed, batch_size):
        print("DEBUG: Параметры функции get_image_embeds")
        print(f"self: {self}")
        print(f"clip_embed: {clip_embed}")
        print(f"type(clip_embed): {type(clip_embed)}")
        print(f"shape of clip_embed: {getattr(clip_embed, 'shape', 'N/A')}")

        print(f"clip_embed_zeroed: {clip_embed_zeroed}")
        print(f"type(clip_embed_zeroed): {type(clip_embed_zeroed)}")
        print(f"shape of clip_embed_zeroed: {getattr(clip_embed_zeroed, 'shape', 'N/A')}")
    ...
    def get_image_embeds_faceid_plus(self, face_embed, clip_embed, s_scale, shortcut, batch_size):
        ...
        print("Debug info - параметры функции:")
        print(f"self: {self}")
        print(f"face_embed: {face_embed}")
        print(f"type(face_embed): {type(face_embed)}")
        print(f"shape of face_embed: {getattr(face_embed, 'shape', None)}")

        print(f"clip_embed: {clip_embed}")
        print(f"type(clip_embed): {type(clip_embed)}")
        print(f"shape of clip_embed: {getattr(clip_embed, 'shape', None)}")

        print(f"s_scale: {s_scale}")
        print(f"type(s_scale): {type(s_scale)}")

        print(f"shortcut: {shortcut}")
        print(f"type(shortcut): {type(shortcut)}")
...
class IPAdapterUnifiedLoader:
    ...
    def load_models(self, model, preset, lora_strength=0.0, provider="CPU", ipadapter=None):
        print("DEBUG: Параметры функции load_models")
        print(f"self: {self}")
        ...
        print(f"type(preset): {type(preset)}")

        print(f"lora_strength: {lora_strength}")
        print(f"type(lora_strength): {type(lora_strength)}")

        print(f"provider: {provider}")
        print(f"type(provider): {type(provider)}")

        print(f"ipadapter: {ipadapter}")
        print(f"type(ipadapter): {type(ipadapter)}")
