...
def get_clipvision_file(preset):
    print("DEBUG: Параметры функции get_clipvision_file")
    ...
    print("\033[91mDEBUG: clipvision_list\033[0m")
    print(f"Тип clipvision_list: {type(clipvision_list)}")
    print(f"Количество моделей: {len(clipvision_list)}")
    print("Список моделей:")
    for i, model in enumerate(clipvision_list):
        print(f"  [{i}] {model}")
    ...
    print(f"clipvision_file: {clipvision_file}")

    return clipvision_file

def get_ipadapter_file(preset, is_sdxl):
    print("\033[91mDEBUG: Параметры функции get_ipadapter_file\033[0m")
    print(f"preset: {preset}")
    print(f"type(preset): {type(preset)}")
    ...
    print(f"ipadapter_file: {ipadapter_file}")
